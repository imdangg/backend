...
import static com.project.imdang.common.application.constant.RequestPath.CHECK_NOTIFICATION;
import static com.project.imdang.common.application.constant.RequestPath.LIST_NOTIFICATION;
...
public class NotificationController {
    ...
    @Operation(description = "Unchecked 알림 유무 조회 API")
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
                    description = "Unchecked 알림 유무 조회 성공")
    })
    @GetMapping(CHECK_NOTIFICATION)
