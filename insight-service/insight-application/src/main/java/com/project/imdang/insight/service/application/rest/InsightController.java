...
public class InsightController {
    ...
    public ResponseEntity<Page<InsightResponse>> listByApartmentComplex(
            @ModelAttribute @Valid ListInsightByApartmentComplexQuery listInsightByApartmentComplexQuery) {
        Page<InsightResponse> insightResponses = insightApplicationService
                .listInsightByApartmentComplex(listInsightByApartmentComplexQuery);
        return ResponseEntity.ok(insightResponses);
    }
