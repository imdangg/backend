...
public class MemberSnapshot extends BaseEntity<MemberSnapshotId> {
    ...
    @Builder
    public MemberSnapshot(MemberSnapshotId id, MemberId memberId, SnapshotId snapshotId, InsightId insightId, ExchangeRequestId exchangeRequestId, ZonedDateTime createdAt) {
        setId(id);
