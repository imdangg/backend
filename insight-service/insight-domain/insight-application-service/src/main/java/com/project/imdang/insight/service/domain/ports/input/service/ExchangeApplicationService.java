...
public interface ExchangeApplicationService {
    ...
    // 내가 요청한 내역
    ListExchangeRequestResponse listExchangeRequestedByMe(ListExchangeRequestedByMeQuery listExchangeRequestedByMeQuery) ;
    // 다른 사람이 요청한 내역
    ListExchangeRequestResponse listExchangeRequestedByOthers(ListExchangeRequestedByOthersQuery listExchangeRequestedByOthersQuery);
}
