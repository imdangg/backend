...
public interface ExchangeApplicationService {
    ...
    // 내가 요청한 내역
    ListExchangeRequestResponse listExchangeRequestCreatedByMe(String memberId);
    // 다른 사람이 요청한 내역
    ListExchangeRequestResponse listExchangeRequestCreatedByOthers(String memberId);
}
