...
/*
    ...
    static FavorableNews favorableNews = FavorableNews.builder()
            ...
            .environments(Set.of(FavorableNews.Environment.하천_복원, FavorableNews.Environment.대형_공원))
            .cultures(Set.of(FavorableNews.Culture.대형_병원, FavorableNews.Culture.문화센터))
            .industries(Set.of(FavorableNews.Industry.산업_단지, FavorableNews.Industry.기업_이전))
