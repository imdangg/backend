...
export async function fetchApartmentComplexesOfInsightsCreatedByMe(siGunGu, eupMyeonDong) {
    const response = await fetch(`${API_URL}/insights/created-by-me/apartment-complexes`, {
        // method: "GET",
        headers: {
...
export async function fetchInsightsByDate() {
    const response = await fetch(`${API_URL}/insights/by-date`, {
        // method: "GET",
        headers: {
            "Content-Type": "application/json",
            ...getAuthHeaders()
...
export async function fetchInsightsByApartmentComplex(apartmentComplexName) {
    const response = await fetch(`${API_URL}/insights/by-apartment-complex?apartmentComplexName=${apartmentComplexName}`, {
        // method: "GET",
        headers: {
            "Content-Type": "application/json",
            ...getAuthHeaders()
...
export async function updateInsight(payload) {
    const response = await fetch(`${API_URL}/insights/update`, {
        method: 'POST',
        headers: {
            ...getAuthHeaders()
        },
