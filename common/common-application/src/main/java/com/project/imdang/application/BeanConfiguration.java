package com.project.imdang.application;


import com.project.imdang.application.security.filter.JwtAuthFilter;
import com.project.imdang.application.security.jwt.JwtAuthenticationEntryPoint;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/kakao", "/auth/google", "/auth/apple","/auth/test", "/error",
